...
func (r *CLIClient) ZDBDeploy(ctx context.Context, zdb ZDB, projectName string) (ZDB, error) {
...
func (r *CLIClient) ZDBDelete(ctx context.Context, projectName string) error {
	// TODO: fix canceling
...
func (r *CLIClient) ZDBGet(ctx context.Context, projectName string) (ZDB, error) {
	// get the contract
