...
func (r *CLIClient) GatewayNameDeploy(ctx context.Context, gatewayNameModel GatewayNameModel, projectName string) (GatewayNameModel, error) {
...
func (r *CLIClient) GatewayNameDelete(ctx context.Context, projectName string) error {
...
func (r *CLIClient) GatewayNameGet(ctx context.Context, projectName string) (GatewayNameModel, error) {
