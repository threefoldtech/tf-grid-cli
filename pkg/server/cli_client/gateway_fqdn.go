...
func (r *CLIClient) GatewayFQDNDeploy(ctx context.Context, gatewayFQDNModel GatewayFQDNModel, projectName string) (GatewayFQDNModel, error) {
...
func (r *CLIClient) GatewayFQDNDelete(ctx context.Context, projectName string) error {
...
func (r *CLIClient) GatewayFQDNGet(ctx context.Context, projectName string) (GatewayFQDNModel, error) {
