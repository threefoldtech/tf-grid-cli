...
func (r *CLIClient) MachinesDeploy(ctx context.Context, model MachinesModel, projectName string) (MachinesModel, error) {
	/*
...
func (r *CLIClient) deployMachinesWorkloads(ctx context.Context, model *MachinesModel, projectName string) (map[uint32]uint64, error) {
...
func (r *CLIClient) deployMahchinesNetwork(ctx context.Context, model *MachinesModel, projectName string) (*workloads.ZNet, error) {
	nodeList := []uint32{}
...
func (r *CLIClient) extractWorkloads(machine *Machine, networkName string) (workloads.VM, []workloads.Disk, []workloads.QSFS) {
	disks := []workloads.Disk{}
	qsfss := []workloads.QSFS{}
...
func (r *CLIClient) MachinesDelete(ctx context.Context, projectName string) error {
...
func (r *CLIClient) MachinesGet(ctx context.Context, modelName string, projectName string) (MachinesModel, error) {
...
func (r *CLIClient) constructMachinesModelFromContracts(ctx context.Context, nodeDeploymentID map[uint32]uint64, modelName string, net Network) (MachinesModel, error) {
	model := MachinesModel{
		Name:    modelName,
		Network: net,
	}
